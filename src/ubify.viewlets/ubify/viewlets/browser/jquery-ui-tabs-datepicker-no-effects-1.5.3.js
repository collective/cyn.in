...
function Datepicker() {
	...
	this.regional[''] = { // Default regional settings
		clearText: ui_datepicker_clear_text_msg, // Display text for clear link
		clearStatus: ui_datepicker_clear_status_msg, // Status text for clear link
		closeText: ui_datepicker_close_text_msg, // Display text for close link
		closeStatus: ui_datepicker_close_status_msg, // Status text for close link
		prevText: '&#x3c;' + ui_datepicker_prev_text_msg, // Display text for previous month link
		prevStatus: ui_datepicker_prev_status_msg, // Status text for previous month link
		nextText: ui_datepicker_next_text_msg + '&#x3e;', // Display text for next month link
		nextStatus: ui_datepicker_next_status_msg, // Status text for next month link
		currentText: ui_datepicker_current_text_msg, // Display text for current month link
		currentStatus: ui_datepicker_current_status_msg, // Status text for current month link
		monthNames: ['January','February','March','April','May','June',
			'July','August','September','October','November','December'], // Names of months for drop-down and formatting
		monthNamesShort: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'], // For formatting
		monthStatus: ui_datepicker_month_status_msg, // Status text for selecting a month
		yearStatus: ui_datepicker_year_status_msg, // Status text for selecting a year
		weekHeader: ui_datepicker_week_header_msg, // Header for the week of the year column
		weekStatus: ui_datepicker_week_status_msg, // Status text for the week of the year column
		dayNames: ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'], // For formatting
		dayNamesShort: ['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'], // For formatting
		dayNamesMin: ['Su','Mo','Tu','We','Th','Fr','Sa'], // Column headings for days starting at Sunday
		dayStatus: ui_datepicker_day_status_msg, // Status text for the day of the week selection
		dateStatus: ui_datepicker_date_status_msg, // Status text for the date selection
		dateFormat: 'mm/dd/yy', // See format options on parseDate
		firstDay: 0, // The first day of the week, Sun = 0, Mon = 1, ...
		initStatus: ui_datepicker_init_status_msg, // Initial Status text on opening
