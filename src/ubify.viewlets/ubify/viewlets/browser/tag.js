    ...
    $.fn.tagSuggest = function (options) {
        ...
        return this.each(function () {
            ...
            function showSuggestions(el, key) {
                ...
                strreplace = el.value.replace(/, +/g,',');
                strreplace = strreplace.replace(/ +,/g,',');
                workingTags = strreplace.split(settings.separator);
                matches = [];
            ...
            function setSelection() {
                ...
                strreplace = v.replace(/, +/g,',');
                strreplace = strreplace.replace(/ +,/g,',');
                currentTags = strreplace.split(settings.separator);
