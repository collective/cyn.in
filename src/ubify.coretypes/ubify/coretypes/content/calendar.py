...
#    archetype_name = BaseClass.archetype_name
    ...
    def manage_afterAdd(self, item, container):
        ...
        subtyper.change_type(self, u'p4a.plonecalendar.CalendarCalendar')
        #subtyper.existing_type(context)
        #interfaces.ISubtyped.providedBy(context)
        
registerATCT(Calendar, PROJECTNAME)
