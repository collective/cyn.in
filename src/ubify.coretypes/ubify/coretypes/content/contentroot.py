...
from ubify.coretypes.interfaces import IImportExportCoretype,ISyndication,IApplicationPerspectives, ITypesRestriction
from Products.CMFCore.utils import getToolByName

schema = DefaultSchema.copy()


class ContentRoot(BaseClass):
    implements(IImportExportCoretype,ISyndication,IApplicationPerspectives,ITypesRestriction)

    __doc__ = BaseClass.__doc__ + "(customizable version)"

    portal_type = "ContentRoot"
    ...
    def getEntries(self,num_of_entries):
        ...
        return self.queryfolderbytype(currentpath= portal_path)[0][:num_of_entries]
...
registerATCT(ContentRoot, PROJECTNAME)