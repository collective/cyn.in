...
from ubify.policy.tests.base import UbifyPolicyTestCase

class TestSetup(UbifyPolicyTestCase):
    def afterSetUp(self):
    ...
    def test_portal_title(self):
        self.assertEquals("Ubify", self.portal.getProperty('title'))

    def test_portal_description(self):
        self.assertEquals("Ubify: Instant Collaboration.",self.portal.getProperty('description'))
    ...
    def test_theme_installed(self):
        ...
        layer = skins.getSkinPath('Ubify Theme')
        #self.failUnless('ubify_theme_custom_templates' in layer)
        self.assertEquals('Ubify Default Theme', skins.getDefaultSkin())        
