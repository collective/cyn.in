...
class IMyItemsPortlet(IPortletDataProvider):
...
class Renderer(base.Renderer):
    _template = ViewPageTemplateFile('myitemsportlet.pt')
    ...
    def __init__(self, *args):
        ...
        self.typesToShow = spacesdefaultaddablenonfolderishtypes + ('StatuslogItem','Discussion Item',)
        self.plone_view = getMultiAdapter((self.context, self.request),name='plone')
        self.title = "My Recent Items"
...
class EditForm(base.EditForm):
    form_fields = form.Fields(IMyItemsPortlet)
    label = _(u"Edit My Items Portlet")
    description = _(u"This portlet displays items created by current user.")
