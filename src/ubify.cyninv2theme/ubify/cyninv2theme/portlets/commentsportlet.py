...
class Renderer(base.Renderer):
    _template = ViewPageTemplateFile('commentsportlet.pt')
    ...
    def __init__(self, *args):
        ...
        self.typesToShow = 'Discussion Item'
...
class AddForm(base.AddForm):
    form_fields = form.Fields(ICommentsPortlet)
    label = _(u"Add Recent Comments Portlet")
    description = _(u"A portlet that renders a list of recent comments within the context of the space and all contained spaces.")
...
class EditForm(base.EditForm):
    form_fields = form.Fields(ICommentsPortlet)
    label = _(u"Edit Recent Comments Portlet")
    description = _(u"A portlet that renders a list of recent comments within the context of the space and all contained spaces.")
