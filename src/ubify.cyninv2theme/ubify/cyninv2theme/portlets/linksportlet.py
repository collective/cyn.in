...
class ILinksPortlet(IPortletDataProvider):
...
class Renderer(base.Renderer):
    _template = ViewPageTemplateFile('linksportlet.pt')
...
class AddForm(base.AddForm):
    form_fields = form.Fields(ILinksPortlet)
    label = _(u"Add Links Portlet")
    description = _(u"This portlet displays recently modified links.")
