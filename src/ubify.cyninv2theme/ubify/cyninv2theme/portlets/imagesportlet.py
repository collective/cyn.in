...
class IImagesPortlet(IPortletDataProvider):
...
class Renderer(base.Renderer):
    _template = ViewPageTemplateFile('imagesportlet.pt')
...
class AddForm(base.AddForm):
    form_fields = form.Fields(IImagesPortlet)
    label = _(u"Add Images Portlet")
    description = _(u"This portlet displays recently modified images.")
