...
class Renderer(base.Renderer):
    _template = ViewPageTemplateFile('eventsportlet.pt')
...
class AddForm(base.AddForm):
    ...
    label = _(u"Add Event Portlet")
    description = _(u"This portlet displays recently modified events.")
