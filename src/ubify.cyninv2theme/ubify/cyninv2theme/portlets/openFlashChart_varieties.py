...
class Area_Line(varieties):
	def __init__(self, alpha = None, colour = None, text = None, fontsize = None, values = None, fill = None, fill_alpha = None):
		...
		self.set_fill_alpha(fill_alpha)
		self.set_fill(fill)

	def set_fill_alpha(self, fill_alpha):
		if fill_alpha:
...
class Pie(varieties):
	def __init__(self, alpha = None, colour = None, text = None, fontsize = None, values = None, start_angle = None, animate = None, colours = None, label_colour = None):
		...
		self.set_animate(animate)
		self.set_colours(colours)
		self.set_label_colour(label_colour)
...
##########################################
# shape_point class for making shapes
class shape_point(dict):
...
# Shape class
class Shape(dict):
	def __init__(self, colour = None, shape_points = None):
		self['type'] = 'shape'
		self.set_colour(colour)
		self.append_value(shape_points)

	def set_colour(self, colour):
		if colour:
			self['colour'] = colour

	def append_value(self, shape_points):
		if shape_points:
			try:
				self['values'].append(shape_points)
			except:
				self['values'] = [shape_points]
